...
3. Ending: chain-only resolution, consistent combs, no sold watch; preserve shared tenderness.
4. Earlier repairs: mirror/hair order, merchant identities, costume and entry/hand joins. Find existing alternatives before adding gaps to final round.
5. Verify all remaining candidate sources, map every final shot and total missing duration. Freeze finite takes and credit ceiling together before generation.

## First source evidence

- Source SHA: bdf5093956be17f63f708038a7fd216c83f74115712d27a9622aaff7e1f44d31; production/award-candidate/della-chain-only-r13.mp4.
- Target: B041, Della's eager chain presentation.
- Full source: 241 native frames, 24fps, 10.041667 seconds; all61 six-per-second samples visually inspected in source receipt000000.
- Observed: Della holds fine pale chain between her hands, looks down then toward offscreen Jim with a warm proud smile. No watch visible in sampled field.
...
Parallel-build integration now reaches16admitted hashes: added cherishingf770030c, Jimrevelationfad6ce3e, and croppedJimresponse91b7f625. OriginalJimportrait40a9eba1 additionally admits disjoint0–168; ancient-gifts8a0bc891 extends to0–236. All previous decisions are preserved in hash-pinned history. Combs plan supplies38.625of50.167seconds, with two explicit action gaps totaling11.542seconds. Ending design reduces remaining coverage to15s domestic resolution plus8.667s retreat and prepares two finite takes (15s+10s), estimated17,500credits with18,000subcap proposed but NOT allocated or spent. Coordinate against the entire33,000remaining budget and chain/other gaps before dispatch. Opening selections require no confirmed new take; formal receipts in progress. No film bake/publication yet.

Current total13admitted hashes: reassurancec2d7c32d native0–240 with mandatory crop240,0,1440,810 and comfort3841beb5 native0–192 are now admitted. Reaction8c1a9049 is extended to0–240 with unchanged crop after all additional42native frames were inspected; the earlier198-frame decision is preserved in explicit hash-pinned revision history. Candidate cut retains the upward glance and shortens only the settled comfort tail. Remaining33,000credits unchanged; no new generation, bake or publication.
